...
$(document).ready(function(){
    ...
    $(".add-more").click(function(e){
        e.preventDefault();
        next = next + 1;
        //var newIn = '<div class="row" id="field'+next+'"><div class="input-field col s4"><input placeholder="Source" id="src'+next+'" type="number" class="validate"></div><div class="input-field col s4"><input placeholder="Destination" id="dest'+next+'" type="number" class="validate"></div><div class="input-field col s2"><label><input type="checkbox" class="check" id="spec'+next+'" value='+next+'><span></span></label></div><div class="input-field col s2"><a class="btn-floating white black-text remove-me" id="remove' + (next) + '"><i class="material-icons black-text">close</i></a></div></div>';
        var inside = '<div class="input-field col s4"><input placeholder="Source" id="src'+next+'" type="number" class="validate"></div><div class="input-field col s4"><input placeholder="Destination" id="dest'+next+'" type="number" class="validate"></div><div class="input-field col s2"><label><input type="checkbox" class="check" id="spec'+next+'" value='+next+'><span></span></label></div><div class="input-field col s2"><a class="btn-floating white black-text remove-me" id="remove' + (next) + '"><i class="material-icons black-text">close</i></a></div>';
        var newIn = document.createElement('div');
        newIn.className = "row";
        newIn.id = "field"+next; 
        newIn.innerHTML= inside;
        //document.getElementById('form-fields').innerHTML += newIn;
        document.getElementById('form-fields').appendChild(newIn);
        ...
        success:function(json){
         ...
         var sormark = L.Icon.extend({
            ...
            for(car=0;car<json.paths.length;car++)
            {
                ...
                // polyarr[car] = [];
                // for(path=0;path<json.paths[car].length;path++)
                // {
                //     // var x = L.polyline.antPath(json.paths[car][path],{color:col_arr[car%10] ,delay:800, weight:7, pulseColor:'#000000'});
                //     // x.addTo(map);
                //     // polyarr[car].push(x);
                //
                ...
                sm.push('1');
                var x = L.polyline(disp[car],{color:col_arr[car%10] ,weight:7, pulseColor:'#000000', snakingSpeed: 100});
                x.addTo(map).snakeIn();
                polyarr.push(x);
            }
